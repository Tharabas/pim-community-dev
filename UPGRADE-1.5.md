...
└── MongoDB
    └── Normalizer          -> format "mongodb_json", used to generate the field normalized_data in a product mongo document
...
Pim/Bundle/CatalogBundle/MongoDB/Normalizer -> Pim/Bundle/CatalogBundle/Normalizer/MongoDB/Document
Pim/Component/Catalog/Normalizer/MongoDB/NormalizedData -> Pim/Bundle/CatalogBundle/Normalizer/MongoDB/NormalizedData
 -> to normalize MongoDB in CatalogBundle because glue to Mongo

Pim/Bundle/EnrichBundle/Normalizer -> Pim/Bundle/EnrichBundle/Normalizer/InternalRest
 -> only used by rest internal api (UI)

Other to re-order
│   ├── ImportExportBundle
│   │   ├── Normalizer      -> versioning
│   ├── ReferenceDataBundle
│   │   ├── Normalizer      -> Flat and Structured
│   ├── UserBundle
│   │   ├── Normalizer
│   ├── LocalizationBundle
│   │   ├── Normalizer      -> Why not in component?
    ├── Localization
    │   ├── Denormalizer    -> Flat and Structured
    │   ├── Normalizer      -> Flat and Structured
