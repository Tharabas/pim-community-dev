...
- Change constructor of `Pim\Bundle\LocalizationBundle\Twig\AttributeOptionExtension`. Add `Pim\Component\Localization\Presenter\PresenterRegistryInterface` and `Pim\Component\Localization\LocaleResolver`
